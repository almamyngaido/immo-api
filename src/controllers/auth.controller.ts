...
export class AuthController {
  ...
  // ─── Redirection vers l'app (ouverte depuis le lien email) ────────────────
  // La saisie du nouveau mot de passe se fait maintenant dans un écran
  // Flutter natif (ResetPasswordView), pas dans un formulaire web — ce lien
  // ne fait que relayer le token vers l'app, même pattern que le retour Wave.
  @get('/reset-password', {
    responses: {'200': {description: 'Redirection vers l\'app ou page d\'erreur'}},
  })
